...
<div class="row">
    <div class="col-md-12">
        <img class="img-rounded center-block" style="padding-top:34px;" height="400px" src="/images/sisters.jpg" alt="Katie and younger sister, Karie" title="Random Halloween picture from childhood">
    </div>
</div>
@endsection
